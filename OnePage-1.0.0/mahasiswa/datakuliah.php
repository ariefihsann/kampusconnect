                                        ...
                                        <div class="card border-0 shadow-sm">
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="card border-0 shadow-sm mt-5">
                                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                                        <h5 class="mb-0">Riwayat Pengumpulan Tugas</h5>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover align-middle mb-0">
                                                                <thead class="table-light">
                                                                    <tr>
                                                                        <th width="25%" class="ps-4">Tugas</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $query_riwayat = "SELECT pengumpulan_tugas.*, tugas.judul 
                                                                    FROM pengumpulan_tugas 
                                                                    JOIN tugas ON pengumpulan_tugas.id_tugas = tugas.id_tugas
                                                                    WHERE pengumpulan_tugas.id_mahasiswa = '$id_mahasiswa'
                                                                    AND tugas.id_dosen = '$id_dosen'
                                                                    ORDER BY pengumpulan_tugas.waktu_pengumpulan DESC";
                                                                    ...
                                                                    if (mysqli_num_rows($result_riwayat) > 0) {
                                                                        while ($row_riwayat = mysqli_fetch_assoc($result_riwayat)) {
                                                                            $status = $row_riwayat['status_pengumpulan'];
                                                                            $nilai = $row_riwayat['nilai'] ?? '-';
                                                                            $file_name = $row_riwayat['lampiran_file'];
                                                                            $waktu_pengumpulan = date("d M Y, H:i", strtotime($row_riwayat['waktu_pengumpulan']));
                                                                            $catatan = $row_riwayat['catatan'] ?? '';

                                                                            // Status badge styling
                                                                            $badge_class = 'bg-secondary';
                                                                            $badge_icon = 'solar:clock-circle-bold-duotone';

                                                                            if ($status == 'Terkumpul') {
                                                                                if ($nilai !== '-') {
                                                                                    $badge_class = 'bg-success';
                                                                                    $badge_icon = 'solar:check-circle-bold-duotone';
                                                                                } else {
                                                                                    $badge_class = 'bg-primary';
                                                                                    $badge_icon = 'solar:upload-square-bold-duotone';
                                                                                }
                                                                                ...
                                                                                <td class="ps-4">
                                                                                    <div class="d-flex align-items-center">
                                                                                        <div class="bg-blue bg-opacity-10 rounded p-2 me-3">
                                                                                            <iconify-icon icon="solar:documents-bold-duotone" class="text-blue fs-5"></iconify-icon>
                                                                                        </div>
                                                                                        <div>
                                                                                            <h6 class="mb-0"><?= htmlspecialchars($row_riwayat['judul']) ?></h6>
                                                                                            <?php if (!empty($catatan)): ?>
                                                                                                <small class="text-muted"><?= htmlspecialchars($catatan) ?></small>
                                                                                            <?php endif; ?>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <span class="badge <?= $badge_class ?> bg-opacity-10 text-<?= str_replace('bg-', '', $badge_class) ?> py-2 px-3">
                                                                                        <iconify-icon icon="<?= $badge_icon ?>" class="me-1"></iconify-icon>
                                                                                        <?= $status ?>
                                                                                    </span>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="text-muted"><?= $waktu_pengumpulan ?></div>
                                                                                    ...
                                                                                    <?php if (!empty($file_name)): ?>
                                                                                        <div class="d-flex align-items-center">
                                                                                            <div class="bg-light rounded p-2 me-2">
                                                                                                ...
                                                                                                $file_icon = 'solar:file-bold-duotone';

                                                                                                if (in_array($file_ext, ['pdf'])) {
                                                                                                    $file_icon = 'solar:file-text-bold-duotone';
                                                                                                } elseif (in_array($file_ext, ['doc', 'docx'])) {
                                                                                                    $file_icon = 'solar:file-doc-bold-duotone';
                                                                                                } elseif (in_array($file_ext, ['zip', 'rar'])) {
                                                                                                    $file_icon = 'solar:file-zip-bold-duotone';
                                                                                                }
                                                                                                ?>
                                                                                                <iconify-icon icon="<?= $file_icon ?>" class="text-muted"></iconify-icon>
                                                                                            </div>
                                                                                            <div>
                                                                                                <a href="../uploads/<?= $file_name ?>" class="text-primary text-truncate d-block" style="max-width: 200px;" download>
                                                                                                    <?= htmlspecialchars($file_name) ?>
                                                                                                </a>
                                                                                                <small class="text-muted">
                                                                                                    <?php
                                                                                                    $file_path = '../uploads/' . $file_name;
                                                                                                    echo file_exists($file_path) ? round(filesize($file_path) / 1024, 1) . ' KB' : 'File tidak ada';
                                                                                                    ?>
                                                                                                </small>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <td class="text-end pe-4">
                                                                                    <div class="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                                            <li>
                                                                                                <a class="dropdown-item" href="../uploads/<?= $file_name ?>" download>
                                                                                                    <iconify-icon icon="solar:download-bold-duotone" class="me-2"></iconify-icon>
                                                                                                    Download
                                                                                                </a>
                                                                                            </li>
                                                                                            <li>
                                                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#detailModal<?= $row_riwayat['id_pengumpulan'] ?>">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="6" class="text-center py-5">
                                                                                <div class="py-4">
                                                                                    ...
                                                                                    <h5 class="mt-3 text-muted">Belum ada riwayat pengumpulan</h5>
                                                                                    <p class="text-muted">Mahasiswa belum mengumpulkan tugas apapun</p>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    <?php } ?>
                                                    ...
                                                    <?php if (mysqli_num_rows($result_riwayat) > 5): ?>
